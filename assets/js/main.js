...
{% include_relative vendor/smooth-scroll.min.js %}
...
{% include_relative vendor/lg-video.min.js %}
{% include_relative vendor/lg-zoom.min.js %}
{% include_relative vendor/lg-share.min.js %}
{% include_relative vendor/lg-thumbnail.min.js %}
