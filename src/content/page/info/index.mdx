...
The current cost of hosting everything is around **\$7** a month. I will continue paying this for as long as I can.

If you want to help support this you can [make a one-time donation or sponsor the project here](https://github.com/sponsors/FraserThompson).
...
...having said that, all of my videos are hosted [on YouTube](https://www.youtube.com/@dunedinsound), which is a platform run by a profit-driven entity which cares not for people, and would happily abandon us as the moment the profit incentive went away. This is because hosting video is very expensive. I retain original copies of all videos though, and if the need arose I could self-host.
